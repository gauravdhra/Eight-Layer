...
export class QuizService {
  ...
  getQuiz(chapterCode, entid) {
    return this.httpClient.get<any>('https://gvb0azqv1e.execute-api.us-east-1.amazonaws.com/dev/quize/listofquize?chapter_code=' + chapterCode + '&entid=' + entid);
  }
}
